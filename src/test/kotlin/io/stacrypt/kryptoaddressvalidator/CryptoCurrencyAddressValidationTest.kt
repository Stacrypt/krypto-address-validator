...
fun String.isValidCryptoCurrencyAddress(cryptocurrency: Cryptocurrency, network: Network, chainType: ChainType? = null) =
...
class CryptocurrencyAddressValidationTest {
    ...
    fun testStellarAddressValidator() {
        Assert.assertTrue("GBZVMDOMNU5ZNDAUVHCSZXFJ6FJRBNXFL6NTY2BBANBVNM6NWPGTFUCV".isValidCryptoCurrencyAddress(
            Cryptocurrency.XLM,
            StellarNetwork.Mainnet
        ))
        Assert.assertTrue("GD3E26NXTYQUQ7VC6HUA6FIACRXDQRWAJKMOGDHFDC6WMTCYQRZJQ4VH".isValidCryptoCurrencyAddress(
            Cryptocurrency.XLM,
            StellarNetwork.Mainnet
        ))
        Assert.assertFalse("GDWG4OXGMCQ2DZ6MFQ4BAM7SHIVN7BXD2KXQYUIIVJOO7Y3AGG2KQZ5".isValidCryptoCurrencyAddress(
            Cryptocurrency.XLM,
            StellarNetwork.Mainnet
        ))
        Assert.assertFalse("GC6VKA3RC3CVU7POEKFORVMHWJNQIRZS6AEH3KIIHCVO3YRGWUV8MSUC".isValidCryptoCurrencyAddress(
            Cryptocurrency.XLM,
            StellarNetwork.Mainnet
        ))
        Assert.assertFalse("cAF44237DTEZIDDMXBJ4KJRA3SUSP45ZXPRUZ3G7MB3JD2KJ2LPF6VBX".isValidCryptoCurrencyAddress(
            Cryptocurrency.XLM,
            StellarNetwork.Mainnet
        ))
    }
    ...
    fun testSolanaAddressValidator() {
        Assert.assertTrue("BidEGY4WK4vorB7qjGrCbXQnt9FYyb4dtUQtyoFpUWUW".isValidCryptoCurrencyAddress(
            Cryptocurrency.SOL,
            SolanaNetwork.Mainnet
        ))
        Assert.assertTrue("GVXRSBjFk6e6J3NbVPXohDJetcTjaeeuykUpbQF8UoMU".isValidCryptoCurrencyAddress(
            Cryptocurrency.SOL,
            SolanaNetwork.Mainnet
        ))
        Assert.assertTrue("CuieVDEDtLo7FypA9SbLM9saXFdb1dsshEkyErMqkRQq".isValidCryptoCurrencyAddress(
            Cryptocurrency.SOL,
            SolanaNetwork.Mainnet
        ))
        Assert.assertTrue("HekM1hBawXQu6wK6Ah1yw1YXXeMUDD2bfCHEzo25vnEB".isValidCryptoCurrencyAddress(
            Cryptocurrency.SOL,
            SolanaNetwork.Mainnet
        ))
        Assert.assertTrue("Cici3VkBztsxuZucqBKuiT8pfUtbdNTH3sLSVfTyi7rM".isValidCryptoCurrencyAddress(
            Cryptocurrency.SOL,
            SolanaNetwork.Mainnet
        ))
        Assert.assertTrue("7ivguYMpnUBMboByJbKc7z31fJMg2pXYQ4nNPziWLchZ".isValidCryptoCurrencyAddress(
            Cryptocurrency.SOL,
            SolanaNetwork.Mainnet
        ))
    }
